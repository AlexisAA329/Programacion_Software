<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TipoVehiculo.aspx.cs" Inherits="pSitioWEB_Prog.BaseDatos.TipoVehiculo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
 <p>
        <br />
        <table class="nav-justified">
            <tr>
                <td colspan="2" style="font-size: xx-large" class="text-center"><strong>ADMINISTRACIÓN DE TIPOS DE VEHICULOS</strong></td>
            </tr>
            <tr>
